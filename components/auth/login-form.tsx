...
export default function LoginForm() {
  ...
  useEffect(() => {
    ...
    if (error === "auth_callback_error") {
      setUrlError("Error en la autenticación con Google. Inténtalo de nuevo.")
    }
  }, [])
      ...
      <Card className="shadow-2xl border-0 bg-white/95 backdrop-blur">
        ...
        <CardContent>
          <div className="space-y-6">
            {urlError && (
              <div className="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-lg">{urlError}</div>
            )}
